...
myGene_train = trainGenerator(4,'/media/rokas/HDD/Undergraduate_Project/UNet_keras/unet/data/LGE/train','LGE','PS',data_gen_args_train,save_to_dir = None,target_size=(512,512),seed=9,show_data=False,threshold = False)
...
model = unet(loss=tversky_loss)
model_checkpoint = ModelCheckpoint('unet_LGE_tl_beta_0.7_5000e.hdf5', monitor='val_loss',verbose=1, save_best_only=True)
